...
const Services = () => {
	...
	return (
		<div id="service" className=" w-full mx-0 px-0 sm:mt-34 md:mt-0 lg:mt-34 py-24  bg-transparent ">
			<h1 className=" mt-48 mx-6 md:mt-3  md:mx-3 p-0 md:p-3 text-4xl md:text-5xl font-roboto text-indigo-600">Some Services</h1>
			<div className=" md:w-full mx-3 md:mx-auto p-1 md:p-6 flex flex-col md:flex-row">
				<div className=" left mx-0 md:mx-3 w-full md:w-1/2 h-auto items-center">
					<div className="box mx-0 md:mx-auto my-12 p-0 flex flex-row rounded items-center  ">
						<img src="img/1.svg" alt="product1" className="m-3 p-0 w-48 h-auto  md:w-72 md:h-auto rounded object-cover" />
					...
					<div className="box mx-0 md:mx-auto my-12 p-0 flex flex-row rounded items-center  ">
						...
						<img src="img/2.svg" alt="product1" className="m-3 p-0 w-48 h-auto  md:w-72 md:h-auto rounded object-cover" />
					</div>
				</div>
				<div className=" right mx-auto md:mx-3  w-full md:w-1/2   h-auto items-center ">
					<div className="box mx-0 md:mx-auto my-12 p-0 flex flex-row rounded items-center  ">
						<img src="img/3.svg" alt="product1" className="m-3 p-0 w-48 h-auto  md:w-72 md:h-auto rounded object-cover" />
					...
					<div className="box mx-0 md:mx-auto my-12 p-0 flex flex-row rounded items-center  ">
						...
						<img src="img/4.svg" alt="product1" className="m-3 p-0 w-48 h-auto  md:w-72 md:h-auto rounded object-cover" />
					</div>
				</div>
			</div>
			<a
